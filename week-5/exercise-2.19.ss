...
;(cc 100 us-coins)
;292
;To do this will require changing the program cc somewhat. It will still have the same form, but it will access
;its second argument differently, as follows:
...
; The order of the coins does not change the answer. Only the difference in denominations.
; This is a combinations problem. The number of options affects the number of combinations.
